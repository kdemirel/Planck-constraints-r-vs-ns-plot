...
- **`PLANCK Data.csv`**: Contains the extracted boundary data for 68% and 95% confidence level (CL) regions from the original plot. This has been done by hand, using `Planck2018_BK14_120mm.pdf` file in an online tool [automeris.io](https://automeris.io).
